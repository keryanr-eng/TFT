...
exports.buildMovementInstruction = buildMovementInstruction;
exports.buildRetreatInstruction = buildRetreatInstruction;
...
function buildMovementInstruction(unit, destination, occupied, board) {
...
function buildRetreatInstruction(unit, threat, occupied, board) {
