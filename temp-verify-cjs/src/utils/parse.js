...
exports.inferTargetingRule = inferTargetingRule;
exports.parseStatModifiers = parseStatModifiers;
exports.pickAccentColor = pickAccentColor;
const statAliases = [
    [/pv/i, "health", "percent"],
...
function inferTargetingRule(label) {
...
function parseStatModifiers(statLine) {
    const modifiers = [];
