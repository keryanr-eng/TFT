...
export function SellZone({
  ...
  return (
    <div
      className={clsx(
        "min-w-[14rem] rounded-[1.2rem] border px-3.5 py-2.5 text-left transition duration-150 result-pop",
    ...
    >
      <div className="flex items-center gap-2">
        <div
          className={clsx(
            "grid h-10 w-10 shrink-0 place-items-center rounded-[0.95rem] border text-base font-display",
      ...
      {unitName && sellValue !== undefined ? (
        <p className="mt-2 text-[11px] font-semibold text-rose-100/95">
