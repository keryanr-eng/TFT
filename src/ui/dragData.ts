...
export function setDraggedUnitId(event: DragEvent, unitId: string): void {
...
export function getDraggedUnitId(event: DragEvent): string {
...
export function getDraggedItemId(event: DragEvent): string {
...
export function clearDraggedUnitId(): void {
  activeDraggedUnitId = "";
}
