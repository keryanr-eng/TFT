...
const statAliases: Array<[RegExp, StatKey, "flat" | "percent"]> = [
  [/pv/i, "health", "percent"],
...
export function parseTiers(value: string): number[] {
  return value
    .split("/")
...
export function parsePriority(value: string): ItemPriority {
...
export function inferRole(roleLabel: string): RoleArchetype {
...
export function inferTargetingRule(label: string): TargetingRule {
...
export function parseStatModifiers(statLine: string): StatModifier[] {
