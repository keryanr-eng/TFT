...
const synergyRows = rawSynergies;
export const synergyData = synergyRows.map((row) => {
...
export const synergyById = Object.fromEntries(synergyData.map((synergy) => [synergy.id, synergy]));
export function summarizeSynergies(units) {
