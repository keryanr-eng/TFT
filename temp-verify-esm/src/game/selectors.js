...
export function createPreviewRenderUnit(template) {
...
export function getHumanBench(game) {
...
export function getRenderBoard(game) {
...
export function getCombatEvents(game) {
    return game.combat?.events.slice(-8) ?? [];
}
export function getCombatResultSummary(game) {
...
export function getDebugSnapshot(game) {
